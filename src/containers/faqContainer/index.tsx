              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-4 w-full text-left px-4 py-4 transition-all duration-300 border-l-2 ${active
            ...
            {currentCategory.items.map((item, index) => {
              ...
              return (
                <motion.article
                  key={id}
                  layout
                  className={`transition-all duration-500 border-b border-stone-200 pb-6 ${isOpen ? '' : 'hover:border-slate-400'
                    }`}
                >
                  <button
